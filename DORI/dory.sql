...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/09/2024 às 05:39
...
CREATE TABLE `reservatorios` (
  `id_acude` int(11) NOT NULL,
  `nome_acude` varchar(255) DEFAULT NULL,
  `localizacao` varchar(255) DEFAULT NULL,
  `data_coleta` date DEFAULT NULL,
  `especie_peixe` varchar(255) DEFAULT NULL,
  `quantidade_peixes` int(11) DEFAULT NULL,
  `tamanho_medio_peixes` decimal(10,2) DEFAULT NULL,
...
--
ALTER TABLE `reservatorios`
  MODIFY `id_acude` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
